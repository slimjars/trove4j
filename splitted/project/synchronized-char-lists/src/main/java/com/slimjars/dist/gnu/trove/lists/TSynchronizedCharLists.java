...
public class TSynchronizedCharLists {
     ...
     * <pre>
     *  TCharList list = TSynchronizedCharLists.wrap( new TCharArrayList() );
     *      ...
     *  synchronized( list ) {
     ...
     */
    public static TCharList wrap( TCharList list ) {
	    return ( list instanceof RandomAccess ?
                new TSynchronizedRandomAccessCharList( list ) :
                new TSynchronizedCharList( list ) );
    }

    static TCharList wrap( TCharList list, Object mutex ) {
	    return ( list instanceof RandomAccess ?
