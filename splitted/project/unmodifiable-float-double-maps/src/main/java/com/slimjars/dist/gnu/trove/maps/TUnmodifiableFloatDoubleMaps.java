...
import com.slimjars.dist.gnu.trove.impl.unmodifiable.TUnmodifiableFloatDoubleMap;


public class TUnmodifiableFloatDoubleMaps {

    // Disallow creation of instances of this class
    private TUnmodifiableFloatDoubleMaps() { }
