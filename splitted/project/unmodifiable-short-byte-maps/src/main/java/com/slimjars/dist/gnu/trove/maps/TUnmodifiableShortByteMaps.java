...
import com.slimjars.dist.gnu.trove.impl.unmodifiable.TUnmodifiableShortByteMap;


public class TUnmodifiableShortByteMaps {

    // Disallow creation of instances of this class
    private TUnmodifiableShortByteMaps() { }
     ...
     */
    public static TShortByteMap wrap( TShortByteMap m ) {
