...
import com.slimjars.dist.gnu.trove.impl.sync.TSynchronizedShortFloatMap;


public class TSynchronizedShortFloatMaps {

    // Disallow creation of instances of this class
    private TSynchronizedShortFloatMaps() { }
     ...
     */
    public static TShortFloatMap wrap( TShortFloatMap m ) {
