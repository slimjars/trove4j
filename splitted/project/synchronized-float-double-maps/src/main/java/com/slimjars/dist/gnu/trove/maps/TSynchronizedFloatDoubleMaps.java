...
import com.slimjars.dist.gnu.trove.impl.sync.TSynchronizedFloatDoubleMap;


public class TSynchronizedFloatDoubleMaps {

    // Disallow creation of instances of this class
    private TSynchronizedFloatDoubleMaps() { }
     ...
     * <pre>
     *  TFloatDoubleMap m = TSynchronizedFloatDoubleMaps.wrap( new TFloatDoubleHashMap() );
     *      ...
     ...
     */
    public static TFloatDoubleMap wrap( TFloatDoubleMap m ) {
