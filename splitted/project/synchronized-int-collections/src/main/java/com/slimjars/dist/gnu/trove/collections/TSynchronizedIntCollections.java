...
public class TSynchronizedIntCollections {
     ...
     * <pre>
     *  TIntCollection c = TSynchronizedIntCollections.wrap( myCollection );
     *     ...
     *  synchronized( c ) {
     ...
     */
    public static TIntCollection wrap( TIntCollection c ) {
	    return new TSynchronizedIntCollection(c);
    }

    static TIntCollection wrap( TIntCollection c, Object mutex ) {
