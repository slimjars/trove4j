...
import com.slimjars.dist.gnu.trove.impl.unmodifiable.TUnmodifiableObjectFloatMap;


public class TUnmodifiableObjectFloatMaps {

    // Disallow creation of instances of this class
    private TUnmodifiableObjectFloatMaps() { }
