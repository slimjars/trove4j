...
import com.slimjars.dist.gnu.trove.impl.unmodifiable.TUnmodifiableIntIntMap;


public class TUnmodifiableIntIntMaps {

    // Disallow creation of instances of this class
    private TUnmodifiableIntIntMaps() { }
     ...
     */
    public static TIntIntMap wrap( TIntIntMap m ) {
