...
import com.slimjars.dist.gnu.trove.impl.sync.TSynchronizedDoubleIntMap;


public class TSynchronizedDoubleIntMaps {

    // Disallow creation of instances of this class
    private TSynchronizedDoubleIntMaps() { }
     ...
     * <pre>
     *  TDoubleIntMap m = TSynchronizedDoubleIntMaps.wrap( new TDoubleIntHashMap() );
     *      ...
     ...
     */
    public static TDoubleIntMap wrap( TDoubleIntMap m ) {
