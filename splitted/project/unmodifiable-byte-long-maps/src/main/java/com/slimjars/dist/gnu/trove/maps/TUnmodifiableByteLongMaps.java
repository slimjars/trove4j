...
import com.slimjars.dist.gnu.trove.impl.unmodifiable.TUnmodifiableByteLongMap;


public class TUnmodifiableByteLongMaps {

    // Disallow creation of instances of this class
    private TUnmodifiableByteLongMaps() { }
     ...
     */
    public static TByteLongMap wrap( TByteLongMap m ) {
