...
import com.slimjars.dist.gnu.trove.impl.sync.TSynchronizedDoubleObjectMap;


public class TSynchronizedDoubleObjectMaps {

    // Disallow creation of instances of this class
    private TSynchronizedDoubleObjectMaps() { }
     ...
     * <pre>
     *  TDoubleObjectMap m = TSynchronizedDoubleObjectMaps.wrap( new TDoubleObjectHashMap() );
     *      ...
     ...
     */
    public static <V> TDoubleObjectMap<V> wrap( TDoubleObjectMap<V> m ) {
