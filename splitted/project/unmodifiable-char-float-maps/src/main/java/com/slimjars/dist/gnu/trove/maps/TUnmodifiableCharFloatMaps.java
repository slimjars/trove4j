...
import com.slimjars.dist.gnu.trove.impl.unmodifiable.TUnmodifiableCharFloatMap;


public class TUnmodifiableCharFloatMaps {

    // Disallow creation of instances of this class
    private TUnmodifiableCharFloatMaps() { }
     ...
     */
    public static TCharFloatMap wrap( TCharFloatMap m ) {
