...
import com.slimjars.dist.gnu.trove.impl.unmodifiable.TUnmodifiableByteShortMap;


public class TUnmodifiableByteShortMaps {

    // Disallow creation of instances of this class
    private TUnmodifiableByteShortMaps() { }
     ...
     */
    public static TByteShortMap wrap( TByteShortMap m ) {
