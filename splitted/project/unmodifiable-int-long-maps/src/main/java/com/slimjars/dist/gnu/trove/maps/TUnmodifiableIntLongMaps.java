...
import com.slimjars.dist.gnu.trove.impl.unmodifiable.TUnmodifiableIntLongMap;


public class TUnmodifiableIntLongMaps {

    // Disallow creation of instances of this class
    private TUnmodifiableIntLongMaps() { }
     ...
     */
    public static TIntLongMap wrap( TIntLongMap m ) {
