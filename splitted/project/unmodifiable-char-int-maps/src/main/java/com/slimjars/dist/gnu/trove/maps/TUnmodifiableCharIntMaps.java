...
import com.slimjars.dist.gnu.trove.impl.unmodifiable.TUnmodifiableCharIntMap;


public class TUnmodifiableCharIntMaps {

    // Disallow creation of instances of this class
    private TUnmodifiableCharIntMaps() { }
     ...
     */
    public static TCharIntMap wrap( TCharIntMap m ) {
