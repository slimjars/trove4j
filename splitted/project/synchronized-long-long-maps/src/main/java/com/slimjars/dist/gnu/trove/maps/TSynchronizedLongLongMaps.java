...
import com.slimjars.dist.gnu.trove.impl.sync.TSynchronizedLongLongMap;


public class TSynchronizedLongLongMaps {

    // Disallow creation of instances of this class
    private TSynchronizedLongLongMaps() { }
     ...
     * <pre>
     *  TLongLongMap m = TSynchronizedLongLongMaps.wrap( new TLongLongHashMap() );
     *      ...
     ...
     */
    public static TLongLongMap wrap( TLongLongMap m ) {
