...
import com.slimjars.dist.gnu.trove.impl.unmodifiable.TUnmodifiableShortLongMap;


public class TUnmodifiableShortLongMaps {

    // Disallow creation of instances of this class
    private TUnmodifiableShortLongMaps() { }
