...
import com.slimjars.dist.gnu.trove.impl.unmodifiable.TUnmodifiableObjectByteMap;


public class TUnmodifiableObjectByteMaps {

    // Disallow creation of instances of this class
    private TUnmodifiableObjectByteMaps() { }
     ...
     */
    public static <K> TObjectByteMap<K> wrap( TObjectByteMap<K> m ) {
