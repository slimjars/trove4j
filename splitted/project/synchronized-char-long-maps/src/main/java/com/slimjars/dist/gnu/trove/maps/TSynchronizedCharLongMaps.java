...
import com.slimjars.dist.gnu.trove.impl.sync.TSynchronizedCharLongMap;


public class TSynchronizedCharLongMaps {

    // Disallow creation of instances of this class
    private TSynchronizedCharLongMaps() { }
     ...
     * <pre>
     *  TCharLongMap m = TSynchronizedCharLongMaps.wrap( new TCharLongHashMap() );
     *      ...
     ...
     */
    public static TCharLongMap wrap( TCharLongMap m ) {
