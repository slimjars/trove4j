...
import com.slimjars.dist.gnu.trove.impl.sync.TSynchronizedFloatLongMap;


public class TSynchronizedFloatLongMaps {

    // Disallow creation of instances of this class
    private TSynchronizedFloatLongMaps() { }
     ...
     * <pre>
     *  TFloatLongMap m = TSynchronizedFloatLongMaps.wrap( new TFloatLongHashMap() );
     *      ...
