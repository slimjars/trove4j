...
import com.slimjars.dist.gnu.trove.impl.sync.TSynchronizedDoubleCharMap;


public class TSynchronizedDoubleCharMaps {

    // Disallow creation of instances of this class
    private TSynchronizedDoubleCharMaps() { }
     ...
     * <pre>
     *  TDoubleCharMap m = TSynchronizedDoubleCharMaps.wrap( new TDoubleCharHashMap() );
     *      ...
     ...
     */
    public static TDoubleCharMap wrap( TDoubleCharMap m ) {
