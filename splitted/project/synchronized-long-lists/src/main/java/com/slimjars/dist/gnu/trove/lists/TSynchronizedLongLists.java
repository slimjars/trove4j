...
public class TSynchronizedLongLists {
     ...
     * <pre>
     *  TLongList list = TSynchronizedLongLists.wrap( new TLongArrayList() );
     *      ...
     *  synchronized( list ) {
     ...
     */
    public static TLongList wrap( TLongList list ) {
	    return ( list instanceof RandomAccess ?
                new TSynchronizedRandomAccessLongList( list ) :
                new TSynchronizedLongList( list ) );
    }

    static TLongList wrap( TLongList list, Object mutex ) {
	    return ( list instanceof RandomAccess ?
