...
public class TSynchronizedDoubleCollections {
     ...
     * <pre>
     *  TDoubleCollection c = TSynchronizedDoubleCollections.wrap( myCollection );
     *     ...
     *  synchronized( c ) {
     ...
     */
    public static TDoubleCollection wrap( TDoubleCollection c ) {
	    return new TSynchronizedDoubleCollection(c);
    }

    static TDoubleCollection wrap( TDoubleCollection c, Object mutex ) {
