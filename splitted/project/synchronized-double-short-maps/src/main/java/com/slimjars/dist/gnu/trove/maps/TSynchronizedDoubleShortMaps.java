...
import com.slimjars.dist.gnu.trove.impl.sync.TSynchronizedDoubleShortMap;


public class TSynchronizedDoubleShortMaps {

    // Disallow creation of instances of this class
    private TSynchronizedDoubleShortMaps() { }
     ...
     * <pre>
     *  TDoubleShortMap m = TSynchronizedDoubleShortMaps.wrap( new TDoubleShortHashMap() );
     *      ...
     ...
     */
    public static TDoubleShortMap wrap( TDoubleShortMap m ) {
