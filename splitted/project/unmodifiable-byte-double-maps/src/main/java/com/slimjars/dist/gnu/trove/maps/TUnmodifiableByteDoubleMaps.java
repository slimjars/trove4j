...
import com.slimjars.dist.gnu.trove.impl.unmodifiable.TUnmodifiableByteDoubleMap;


public class TUnmodifiableByteDoubleMaps {

    // Disallow creation of instances of this class
    private TUnmodifiableByteDoubleMaps() { }
     ...
     */
    public static TByteDoubleMap wrap( TByteDoubleMap m ) {
