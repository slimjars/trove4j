...
import com.slimjars.dist.gnu.trove.impl.unmodifiable.TUnmodifiableDoubleLongMap;


public class TUnmodifiableDoubleLongMaps {

    // Disallow creation of instances of this class
    private TUnmodifiableDoubleLongMaps() { }
     ...
     */
    public static TDoubleLongMap wrap( TDoubleLongMap m ) {
