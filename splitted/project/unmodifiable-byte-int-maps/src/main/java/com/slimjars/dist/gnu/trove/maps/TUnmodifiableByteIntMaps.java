...
import com.slimjars.dist.gnu.trove.impl.unmodifiable.TUnmodifiableByteIntMap;


public class TUnmodifiableByteIntMaps {

    // Disallow creation of instances of this class
    private TUnmodifiableByteIntMaps() { }
     ...
     */
    public static TByteIntMap wrap( TByteIntMap m ) {
