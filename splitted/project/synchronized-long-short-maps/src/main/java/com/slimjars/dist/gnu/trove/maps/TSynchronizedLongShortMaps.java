...
import com.slimjars.dist.gnu.trove.impl.sync.TSynchronizedLongShortMap;


public class TSynchronizedLongShortMaps {

    // Disallow creation of instances of this class
    private TSynchronizedLongShortMaps() { }
     ...
     * <pre>
     *  TLongShortMap m = TSynchronizedLongShortMaps.wrap( new TLongShortHashMap() );
     *      ...
     ...
     */
    public static TLongShortMap wrap( TLongShortMap m ) {
