...
import com.slimjars.dist.gnu.trove.impl.sync.TSynchronizedIntByteMap;


public class TSynchronizedIntByteMaps {

    // Disallow creation of instances of this class
    private TSynchronizedIntByteMaps() { }
     ...
     * <pre>
     *  TIntByteMap m = TSynchronizedIntByteMaps.wrap( new TIntByteHashMap() );
     *      ...
     ...
     */
    public static TIntByteMap wrap( TIntByteMap m ) {
