...
import com.slimjars.dist.gnu.trove.impl.unmodifiable.TUnmodifiableShortObjectMap;


public class TUnmodifiableShortObjectMaps {

    // Disallow creation of instances of this class
    private TUnmodifiableShortObjectMaps() { }
