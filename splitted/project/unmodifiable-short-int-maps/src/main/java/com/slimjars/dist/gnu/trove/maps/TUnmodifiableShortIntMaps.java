...
import com.slimjars.dist.gnu.trove.impl.unmodifiable.TUnmodifiableShortIntMap;


public class TUnmodifiableShortIntMaps {

    // Disallow creation of instances of this class
    private TUnmodifiableShortIntMaps() { }
     ...
     */
    public static TShortIntMap wrap( TShortIntMap m ) {
