...
import com.slimjars.dist.gnu.trove.impl.unmodifiable.TUnmodifiableByteCharMap;


public class TUnmodifiableByteCharMaps {

    // Disallow creation of instances of this class
    private TUnmodifiableByteCharMaps() { }
     ...
     */
    public static TByteCharMap wrap( TByteCharMap m ) {
