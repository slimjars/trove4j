...
import com.slimjars.dist.gnu.trove.impl.sync.TSynchronizedLongDoubleMap;


public class TSynchronizedLongDoubleMaps {

    // Disallow creation of instances of this class
    private TSynchronizedLongDoubleMaps() { }
     ...
     * <pre>
     *  TLongDoubleMap m = TSynchronizedLongDoubleMaps.wrap( new TLongDoubleHashMap() );
     *      ...
     ...
     */
    public static TLongDoubleMap wrap( TLongDoubleMap m ) {
