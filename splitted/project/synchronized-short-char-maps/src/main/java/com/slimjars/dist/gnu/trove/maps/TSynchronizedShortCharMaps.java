...
import com.slimjars.dist.gnu.trove.impl.sync.TSynchronizedShortCharMap;


public class TSynchronizedShortCharMaps {

    // Disallow creation of instances of this class
    private TSynchronizedShortCharMaps() { }
     ...
     * <pre>
     *  TShortCharMap m = TSynchronizedShortCharMaps.wrap( new TShortCharHashMap() );
     *      ...
     ...
     */
    public static TShortCharMap wrap( TShortCharMap m ) {
