...
import com.slimjars.dist.gnu.trove.impl.unmodifiable.TUnmodifiableLongIntMap;


public class TUnmodifiableLongIntMaps {

    // Disallow creation of instances of this class
    private TUnmodifiableLongIntMaps() { }
     ...
     */
    public static TLongIntMap wrap( TLongIntMap m ) {
