...
import com.slimjars.dist.gnu.trove.impl.unmodifiable.TUnmodifiableObjectIntMap;


public class TUnmodifiableObjectIntMaps {

    // Disallow creation of instances of this class
    private TUnmodifiableObjectIntMaps() { }
