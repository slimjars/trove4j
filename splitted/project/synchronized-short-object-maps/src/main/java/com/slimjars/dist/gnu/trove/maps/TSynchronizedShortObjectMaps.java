...
import com.slimjars.dist.gnu.trove.impl.sync.TSynchronizedShortObjectMap;


public class TSynchronizedShortObjectMaps {

    // Disallow creation of instances of this class
    private TSynchronizedShortObjectMaps() { }
     ...
     * <pre>
     *  TShortObjectMap m = TSynchronizedShortObjectMaps.wrap( new TShortObjectHashMap() );
     *      ...
     ...
     */
    public static <V> TShortObjectMap<V> wrap( TShortObjectMap<V> m ) {
